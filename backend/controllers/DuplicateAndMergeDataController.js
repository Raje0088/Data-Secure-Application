    ...
    try {
        ...
        const aggregationTotalCount = await rawDataModel.aggregate([
            ...
            },
            {
                $group: {
                    _id: {
                        opticalName: "$optical_name1_db",
                        clientName: "$client_name_db",
                        emails: "$emails",
                        mobile: "$mobiles",
                        pincode: "$pincode_db",
                    },
...
module.exports = { mergeAndDeleteFromAllDB, updateDataMergeAndDelete, findDuplicateRecord, MergeAnddeleteAllRawDBClient, findDuplicateRecordBySearch, mergeAndDelete, deleteRawDBClient }