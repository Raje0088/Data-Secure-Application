...
const { findDuplicateRecord,MergeAnddeleteAllRawDBClient, findDuplicateRecordBySearch, mergeAndDelete, deleteRawDBClient,mergeAndDeleteFromAllDB } = require("../controllers/DuplicateAndMergeDataController")
...
const storage = multer.diskStorage({
    destination: function (req, file, cb) {
        cb(null, path.join(__dirname, '../uploadExcel'))
    },
