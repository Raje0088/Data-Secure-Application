            ...
            <div className="four-btns">
              ...
              {showForm && (
                <div className="form-icon-div">
                  ...
                  <div
                    className={`popup-wrapper ${showFormPopUp ? "show" : ""}`}
                  >
              ...
              <table>
                ...
                {userDataList1.map((todo, index) => {
                  ...
                  const userName = userDataList3.find(
                    (u_name) =>
                      todo.generateUniqueId === u_name.generateUniqueId
                  );
                  return (
                    <tr key={index}>
                      <td>{index + 1}</td>
                      ...
                      <td>
                        {permissionsArray.length > 0 ? (
                          <>
                            {mergedPermissions.create_P && (
                              <span>create, </span>
                            )}
                            {mergedPermissions.update_P && (
                              <span>update, </span>
                            )}
